...
{
    public partial class ucCircuitControl : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        private void Query(string usageCode)
        {
            ...
            if (this.neuTabControl1.TabPages.Count <= 0 || this.myPatients == null) return;
            ...
            {
                //当前Tab页里面还没有输液卡
                object o = Neusoft.FrameWork.WinForms.Classes.UtilInterface.CreateObject(typeof(HISFC.Components.Order.Controls.ucCircuitControl), typeof(Neusoft.HISFC.BizProcess.Interface.IPrintTransFusion));
                if (o == null)
                {
