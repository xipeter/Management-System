...
namespace Neusoft.HISFC.Components.HealthRecord.CaseFirstPage
{
    ...
    public partial class ucOperation : UserControl
    {
        ...
        private Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes operType;
        //产科分娩婴儿记录表 
        ...
        //切口类型
        private Neusoft.FrameWork.WinForms.Controls.PopUpListBox NickType = new Neusoft.FrameWork.WinForms.Controls.PopUpListBox();
        private Neusoft.FrameWork.Public.ObjectHelper NickTypeHelper = new Neusoft.FrameWork.Public.ObjectHelper();

        //愈合类型
        private Neusoft.FrameWork.WinForms.Controls.PopUpListBox CicaType = new Neusoft.FrameWork.WinForms.Controls.PopUpListBox();
        private Neusoft.FrameWork.Public.ObjectHelper CicaTypeHelper = new Neusoft.FrameWork.Public.ObjectHelper();
        //麻醉方式列表
        private Neusoft.FrameWork.WinForms.Controls.PopUpListBox NarcType = new Neusoft.FrameWork.WinForms.Controls.PopUpListBox();
        private Neusoft.FrameWork.Public.ObjectHelper NarcTypeHelper = new Neusoft.FrameWork.Public.ObjectHelper();
        //手术/麻醉医生列表
        private Neusoft.FrameWork.WinForms.Controls.PopUpListBox DoctorType = new Neusoft.FrameWork.WinForms.Controls.PopUpListBox();
        ...
        public int ValueState(ArrayList list)
        {
            ...
            foreach (Neusoft.HISFC.Models.HealthRecord.OperationDetail obj in list)
            {
                ...
                if (!Neusoft.FrameWork.Public.String.ValidMaxLengh(obj.InpatientNO , 14))
                {
                    MessageBox.Show("住院流水号过长");
                    return -1;
                }
                if (!Neusoft.FrameWork.Public.String.ValidMaxLengh(obj.HappenNO , 7))
                {
        ...
        public int AddInfoToTable(ArrayList list)
        {
            ...
            {
                //循环插入数据
                foreach (Neusoft.HISFC.Models.HealthRecord.OperationDetail info in list)
                {
            ...
            //更改标志
            if ((this.operType == Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes.DOC && this.patient.CaseState == "2") || (this.operType == Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes.CAS && (this.patient.CaseState == "3" || this.patient.CaseState == "5")))
            {
                //清空表的标志位
                dtOperation.AcceptChanges();
            }
        ...
        /// 加载数据
        /// </summary>
        public void LoadInfo(Neusoft.HISFC.Models.RADT.PatientInfo patientInfo, Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes Type)
        {
            if (dtOperation == null)
            {
                return;
            ...
            //赋值操作类型
            operType = Type;
            Neusoft.HISFC.BizLogic.HealthRecord.Operation op = new Neusoft.HISFC.BizLogic.HealthRecord.Operation();
            if (patient.ID == "")
            {
                return;
            }
            ...
            if (list.Count == 0)
            {
                if (operType == Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes.CAS)
                {
                    list = op.QueryOperation(Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes.DOC, patient.ID);
                }
            }
        ...
        private bool GetChange(DataTable table, ArrayList list)
        {
            try
            {
                ...
                Neusoft.HISFC.Models.HealthRecord.OperationDetail bb;
                foreach (DataRow row in table.Rows)
                {
                    bb = new Neusoft.HISFC.Models.HealthRecord.OperationDetail();
                    //操作类型 医生站录入的或病案室录入的
                    ...
                    bb.OperationDate = Neusoft.FrameWork.Function.NConvert.ToDateTime(row["手术日期"]);
        ...
        private void SetRow(DataRow row, Neusoft.HISFC.Models.HealthRecord.OperationDetail info)
        {
        ...
        {
            Neusoft.HISFC.BizLogic.Manager.Person per = new Neusoft.HISFC.BizLogic.Manager.Person();
            //获取手术/麻醉医生列表
            ArrayList list = per.GetEmployee(Neusoft.HISFC.Models.Base.EnumEmployeeType.D);
            if (list != null)
            {
            ...
            //定义listBox的单击事件
            DoctorType.SelectItem += new Neusoft.FrameWork.WinForms.Controls.PopUpListBox.MyDelegate(diagType_SelectItem);
        }
        ...
        public void InitICDList()
        {
            ...
            //			Neusoft.HISFC.BizProcess.Fee.Item item = new Neusoft.HISFC.BizProcess.Fee.Item();
            ...
            //定义listBox的单击事件
            ICDType.SelectItem += new Neusoft.FrameWork.WinForms.Controls.PopUpListBox.MyDelegate(diagType_SelectItem);
        }
        /// <summary>
        /// 单击选择事件 
        /// </summary>
        ...
        private void InitNarcList()
        {
            ...
            //				lbDept.Font=new System.Drawing.Font("宋体", 12F);
            //定义listBox的单击事件
            NarcType.SelectItem += new Neusoft.FrameWork.WinForms.Controls.PopUpListBox.MyDelegate(diagType_SelectItem);
        }
        /// <summary>
        /// 初始化切口列表
        /// </summary>
        private void IniNickType()
        {
            ...
            ArrayList list = con.GetList("CAS_INCITYPE");
            if (list != null)
            {
            ...
            //				lbDept.Font=new System.Drawing.Font("宋体", 12F);
            //定义listBox的单击事件
            NickType.SelectItem += new Neusoft.FrameWork.WinForms.Controls.PopUpListBox.MyDelegate(diagType_SelectItem);
        }
        /// <summary>
        /// 初始化愈合列表
        /// </summary>
        private void IniCicaType()
        {
            ...
            //				lbDept.Font=new System.Drawing.Font("宋体", 12F);
            //定义listBox的单击事件
            CicaType.SelectItem += new Neusoft.FrameWork.WinForms.Controls.PopUpListBox.MyDelegate(diagType_SelectItem);
        }
        /// <summary>
        /// 处理fpSpread1,执行科室的回车
        /// </summary>
