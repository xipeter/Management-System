namespace Neusoft.HISFC.Components.HealthRecord.CaseFirstPage
{
    partial class ucFeeInfo
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 0).Text = "统计代码";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 1).Text = "统计名称";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 2).Text = "费用金额";
