...
namespace Neusoft.HISFC.Components.HealthRecord.CaseFirstPage
{
    ...
    public partial class ucFeeInfo : UserControl
    {
        ...
        public int ValueState(ArrayList list)
        {
            ...
            foreach (Neusoft.HISFC.Models.RADT.Patient obj in list)
            {
                ...
                if (Neusoft.FrameWork.Function.NConvert.ToDecimal(obj.IDCard) > (decimal)99999999.99)
                {
        ...
        private void fpSpread1_Sheet1_CellChanged(object sender, FarPoint.Win.Spread.SheetViewEventArgs e)
        {
            if (fpSpread1_Sheet1.ActiveColumnIndex == 2)
            {
                ...
                {
                    //累计金额
                    tempDecimal += Neusoft.FrameWork.Function.NConvert.ToDecimal(fpSpread1_Sheet1.Cells[i, 2].Text);
                }
                //更改合计金额
