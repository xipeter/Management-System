...
namespace Neusoft.HISFC.Components.HealthRecord.CaseFirstPage
{
    public partial class ucCaseMainInfo : Neusoft.FrameWork.WinForms.Controls.ucBaseControl,Neusoft.FrameWork.WinForms.Forms.IInterfaceContainer
    {
       ...
       // =======================以下两个属性作用:如果病案中不存在该患者,责使用窗体传来的值，作为查询基本信息的依据
        ...
        #region addby xuewj 2010-9-14 根据郑大病案室要求调整控件位置 {7B7E1EF0-8AF3-4ebc-8B91-835E141E3276}

        /// <summary>
        /// 不需要按照tableindex获取焦点的控件集合
        /// </summary>
        Hashtable UnGetFoucsHasTable = new Hashtable();

        private bool isDISTGetFous=true;

        [Category("控件设置"),Description("国籍是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("曾用名是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("实习医生是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("病人来源是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("门诊医生是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("进修医生是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("研究生实习医生是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("病人转入前所在医院是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("Hbsag是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("B超号是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("ECT号是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("PET号是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("诊断编码员是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("整理员是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("手术编码员是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("输入人员是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("单病种是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("全血是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("院际会诊是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("远程会诊是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("特级护理是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("I级护理是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("II级护理是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("III级护理是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("重症监护是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("特殊护理是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("门诊诊断是否按照TABINDEX获得焦点")]
        ...
        [Category("控件设置"), Description("入院诊断是否按照TABINDEX获得焦点")]
        ...
        /// <summary>
        /// 根据控件属性,判断是否在不需要按照TABINDEX获得焦点列表中加入或者删除该控件
        /// </summary>
        /// <param name="controlName">控件名称</param>
        /// <param name="control">输入控件</param>
        /// <param name="isGetFoucs">是否必须输入</param>
        ...
        private int InitCountryList()
        {
            ...
            cons.Name = "否";
            newlist.Add(cons);
            this.txtUseNumber.AddItems(newlist); //使用次数

            ArrayList newlist1 = new ArrayList();//传染病卡
            ArrayList newlist2 = new ArrayList();//肿瘤卡
            cons=new Neusoft.HISFC.Models.Base.Const ();
            cons.ID = "1";
            cons.Name = "已报";
            newlist1.Add(cons);
        ...
        public void InitTreeView()
        {
            ...
            {
                childNode.Text += "[" + childNode.Nodes.Count.ToString() + "份]";
            }
        ...
        #region 事件 [废弃] {7B7E1EF0-8AF3-4ebc-8B91-835E141E3276}
        ...
        private int ConvertInfoToPanel(Neusoft.HISFC.Models.HealthRecord.Base info)
        {
            try
            {
                ...
                #region{2FDCC429-B30E-463c-AAD6-6BADCE600458}
                txtDeptDirector.Tag = info.PatientInfo.PVisit.AttendingDirector.ID;//科主任
                txtMorphology.Text = info.PatientInfo.PVisit.TemporaryLocation.User03;//形态学编码
                txtUseNumber.Tag = info.PatientInfo.PVisit.TempDoctor.User01;//抗生素是否使用
                txtUseDays.Text = info.PatientInfo.PVisit.TempDoctor.User02;//抗生素使用次数
                txtCard1.Tag = info.PatientInfo.PVisit.TemporaryLocation.User01;//传染病卡
                txtCard2.Tag=info.PatientInfo.PVisit.TemporaryLocation.User02;//肿瘤卡
        ...
        private int GetInfoFromPanel(Neusoft.HISFC.Models.HealthRecord.Base info)
        {
            ...
            #region{2FDCC429-B30E-463c-AAD6-6BADCE600458}
            if (txtDeptDirector.Tag != null)//科主任
            {
            ...
            info.PatientInfo.PVisit.TemporaryLocation.User03 = txtMorphology.Text;//形态学编码        
            info.PatientInfo.PVisit.TempDoctor.User01 = txtUseNumber.Tag.ToString();//抗生素是否使用
            info.PatientInfo.PVisit.TempDoctor.User02 = txtUseDays.Text;//抗生素使用次数
            info.PatientInfo.PVisit.TemporaryLocation.User01 = txtCard1.Tag.ToString();//传染病卡
            info.PatientInfo.PVisit.TemporaryLocation.User02 = txtCard2.Tag.ToString();//肿瘤卡
            #endregion
            //编码员
            ...
            //集中修改病案室需求{C80E9978-D3E3-4af7-92F3-D91ED5288419}--回收
            if (CaseBase.PatientInfo.CaseState == "5")
            {
        ...
        private int ValidState(Neusoft.HISFC.Models.HealthRecord.Base info)
        {
            ...
            string maritalStatus = "";//婚姻代码
            string relation = "";//联系人关系代码
            int rtn = 0;
            ...
            {
                this.txtRelation.Focus();
                MessageBox.Show("查询互斥关系列表失败!");
                return -1;
            }
            else if (rtn == 1)
            {
                this.txtRelation.Focus();
                MessageBox.Show("婚姻状态和联系人关系不符合逻辑关系,请修改!");
                return -1;
            }
            ...
            if (info.PatientInfo.CaseState != "5")
            {
                ...
                {
                    this.txtFirstDept.Focus();
                    MessageBox.Show("请正确填写转入科室，确保转入科室顺序正确，转入时间不得小于或等于上次转入时间");
                    return -1;
                }
                //必录项
                ArrayList alMustInputControls = new ArrayList();
                alMustInputControls.Add(new object[] { "病案号", this.txtCaseNum });//NeuTextBox
                alMustInputControls.Add(new object[] { "姓名", this.txtPatientName });
                alMustInputControls.Add(new object[] { "性别", this.txtPatientSex });//CustomListBox
                alMustInputControls.Add(new object[] { "年龄", this.txtPatientAge });
                alMustInputControls.Add(new object[] { "出生地", this.txtAreaCode });
                alMustInputControls.Add(new object[] { "民族", this.txtNationality });
                alMustInputControls.Add(new object[] { "住院次数", this.txtInTimes });//ValidatedTextBox
                alMustInputControls.Add(new object[] { "付款方式", this.txtCasPact });
                alMustInputControls.Add(new object[] { "户口地址", this.txtAddressHome });
                alMustInputControls.Add(new object[] { "入院科室", this.txtDeptInHospital });
                alMustInputControls.Add(new object[] { "出院科室", this.txtDeptOut });
                alMustInputControls.Add(new object[] { "入院情况", this.txtCircs });
                alMustInputControls.Add(new object[] { "出院情况", this.txtZG });
                alMustInputControls.Add(new object[] { "实际住院天数", this.txtPiDays });
                alMustInputControls.Add(new object[] { "门住院符合", this.txtCePi });
                alMustInputControls.Add(new object[] { "入出_院符合", this.txtPiPo });
                alMustInputControls.Add(new object[] { "术前_后符合", this.txtOpbOpa });
                alMustInputControls.Add(new object[] { "临床_病理符合", this.txtClPa });
                alMustInputControls.Add(new object[] { "放射_病理符合", this.txtFsBl });
                alMustInputControls.Add(new object[] { "主任医师", this.txtConsultingDoctor });
                alMustInputControls.Add(new object[] { "主治医师", this.txtAttendingDoctor });
                alMustInputControls.Add(new object[] { "住院医师", this.txtAdmittingDoctor });
                alMustInputControls.Add(new object[] { "病案质量", this.txtMrQual });
                alMustInputControls.Add(new object[] { "质控医师", this.txtQcDocd });
                ...
                foreach (object[] objList in alMustInputControls)
                {
                    ...
                    if (tmpControl is Neusoft.FrameWork.WinForms.Controls.NeuTextBox)
                    {
                        ...
                        {
                            txtControl.Focus();
                            MessageBox.Show(objList[0].ToString() + "为必录项");
                            return -1;
                        }
                    }
        ...
        public void ClearInfo()
        {
            try
            {
                ...
                //科主任{2FDCC429-B30E-463c-AAD6-6BADCE600458}
        ...
        private void treeView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            try
            {
                if (this.treeView1.SelectedNode.Text == "出院患者")
                {
                    return;
                }
        ...
        private int SaveLinkRow()
        {
            ...
            for (int i = 0; i < neuSpread1_Sheet1.Rows.Count; i++)
            {
                Neusoft.HISFC.Models.HealthRecord.Visit.LinkWay linkWayObj1=
                    neuSpread1_Sheet1.Rows[i].Tag as Neusoft.HISFC.Models.HealthRecord.Visit.LinkWay;//Tag中的对象

                Neusoft.HISFC.Models.HealthRecord.Visit.LinkWay linkWayObj2 = GetLinkWayObj(i); //根据行的值生成的对象
          ...
          ref Neusoft.HISFC.Models.HealthRecord.Visit.Visit visitObj)
        {
            ...
            for (int i = 0; i < neuSpread1_Sheet1.Rows.Count; i++)
            {
                if (this.neuSpread1_Sheet1.Cells[i, 0].Text == true.ToString())
                {
                    linkWayObj=neuSpread1_Sheet1.Rows[i].Tag as Neusoft.HISFC.Models.HealthRecord.Visit.LinkWay;//Tag中的对象
                    checkCount += 1;
                }
            }
        ...
        #region add by GXLei 2010-9-27 集中修改病案室需求{C80E9978-D3E3-4af7-92F3-D91ED5288419}
        /// <summary>
        /// 
        /// </summary>
        /// <param name="sender"></param>
        ...
        private void ProcessIdNo()
        {
            ...
            if (string.IsNullOrEmpty(idNo.Trim())) //为空的不处理
            {
                return;
            }
            if (idNo.Length == 15)
        ...
        {
            MessageBox.Show("该按钮已停用，请到“病案回收”窗口进行操作。");
            return;

            List<Neusoft.HISFC.Models.RADT.PatientInfo> selectedPatient = this.GetSelectedPatient();
            if (selectedPatient.Count <= 0)
            {
                MessageBox.Show("请选择需要回收的病案");
                return;
            }
            if (MessageBox.Show("确定回收选中的" + selectedPatient.Count + "份病案么？", "提示", MessageBoxButtons.OKCancel) == DialogResult.Cancel)
            {
                return;
            }
            Neusoft.FrameWork.Management.PublicTrans.BeginTransaction();
            ...
            {
                MessageBox.Show("该病案已经回收，无法再次回收");
                return;
            }
        ...
        private int ReceiveSinglePatient(Neusoft.HISFC.Models.RADT.PatientInfo patient, ref string errText)
        {
            ...
            if (baseInfo == null)
            {
                errText = "处理患者" + patient.Name + "[" + patient.PID.PatientNO + "]失败：" + baseDml.Err;
                return -1;
            }
        ...
        private void ucCasPatient_SelectItem(Neusoft.HISFC.Models.HealthRecord.Base obj)
        {
            ...
            if (obj == null)
            {
                MessageBox.Show("查找病案记录失败：" + this.baseDml.Err);
                return;
            }
