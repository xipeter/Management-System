...
namespace Neusoft.HISFC.Components.Manager.Classes
{
    public class Function
    {
      ...
      VALUES
        ...
        private static int CreateNoticeInterfaceCollection()
        {
            ...
            Neusoft.HISFC.BizProcess.Interface.Common.INoticeManager noticeInterface = null;
            try
            {
                string directoryPath = Application.StartupPath + "\\" + Neusoft.FrameWork.WinForms.Classes.Function.PluginPath + "Notice";
                ...
                if (System.IO.Directory.Exists(directoryPath))
                {
                    ...
                    foreach (string str in strNoticeDll)
                    {
                        ...
                        {
                            if (type.GetInterface("Neusoft.HISFC.BizProcess.Integrate.Common.INoticeManager") != null)
                            {
                                noticeInterface = (Neusoft.HISFC.BizProcess.Interface.Common.INoticeManager)System.Activator.CreateInstance(type);
