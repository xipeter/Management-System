...
namespace Neusoft.HISFC.Components.Nurse.Inject
{
    ...
    public partial class ucConfirm : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void ProceedConfirm()
        {
            ...
            //Neusoft.FrameWork.Management.Transaction t2 = new Neusoft.FrameWork.Management.Transaction(Neusoft.FrameWork.Management.Connection.Instance);
            //t2.BeginTransaction();
        ...
        private void InitControl()
        {
            ...
            this.lbName.Text = "";
            this.txtCardNO.Text = "";
            this.dtInject.Value = Neusoft.FrameWork.Function.NConvert.ToDateTime(this.decompound.GetSysDate());
