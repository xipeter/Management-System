...
namespace Neusoft.HISFC.Components.Nurse.Inject
{
    ...
    ///  />
    /// </summary> 
    public partial class ucInjectRegist : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private Neusoft.HISFC.BizProcess.Integrate.Pharmacy pharmacy = new Neusoft.HISFC.BizProcess.Integrate.Pharmacy();
        private Neusoft.HISFC.BizProcess.Integrate.Fee fee = new Neusoft.HISFC.BizProcess.Integrate.Fee();
        private Neusoft.HISFC.BizProcess.Integrate.Registration.Registration regist = new Neusoft.HISFC.BizProcess.Integrate.Registration.Registration();
        ...
        private void ProceedConfirm()
        {
            ...
            this.pharmacy.SetTrans(Neusoft.FrameWork.Management.PublicTrans.Trans);
            ...
            this.regist.SetTrans(Neusoft.FrameWork.Management.PublicTrans.Trans);
