...
namespace Neusoft.HISFC.Components.Nurse.Controls
{
    ...
    public partial class ucBedListView : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        protected Neusoft.HISFC.BizLogic.RADT.OutPatient radtOutPatientManager = new Neusoft.HISFC.BizLogic.RADT.OutPatient();
        ...
        private void ShowPatientInfo()
        {
            ...
            {
                Neusoft.HISFC.Models.Registration.Register patient = this.lsvBedView.SelectedItems[0].Tag as Neusoft.HISFC.Models.Registration.Register;
        ...
        //        Neusoft.FrameWork.Interface.Classes.Function.PopShowControl(this.ucBedChange1);
        //        if (Neusoft.FrameWork.Interface.Classes.Function.PopForm.DialogResult == DialogResult.OK)
        //        {
        //            //刷新床位列表
        //            this.RefreshView();
        //        }
        ...
        private int ChangeItems(int a, int b)
        {
            ...
            return 0;*/
            int parm;
            Neusoft.HISFC.Models.Registration.Register obj_a, obj_b;
            ...
            //两人对调床位
            if (this.lsvBedView.Items[a].Tag.GetType().ToString() == "Neusoft.HISFC.Models.Registration.Register" && this.lsvBedView.Items[b].Tag.GetType().ToString() == "Neusoft.HISFC.Models.Registration.Register")
            {
                obj_a = (Neusoft.HISFC.Models.Registration.Register)this.lsvBedView.Items[a].Tag;
                obj_b = (Neusoft.HISFC.Models.Registration.Register)this.lsvBedView.Items[b].Tag;
            ...
            else if (this.lsvBedView.Items[a].Tag.GetType().ToString() == "Neusoft.HISFC.Models.Registration.Register")
            {
                //患者a换到b床
                return (this.TransPatientToBed( a, b ));

            }
            else if (this.lsvBedView.Items[b].Tag.GetType().ToString() == "Neusoft.HISFC.Models.Registration.Register")
            {
                //患者b换到a床
                return (this.TransPatientToBed( b, a ));
            }
