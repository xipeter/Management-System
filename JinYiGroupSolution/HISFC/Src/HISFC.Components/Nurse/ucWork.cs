...
namespace Neusoft.HISFC.Components.Nurse
{
    ...
    public partial class ucWork : UserControl
    {
        ...
        /// 排班模版类
        /// </summary>
        protected Neusoft.HISFC.BizLogic.Nurse.Work work = new Neusoft.HISFC.BizLogic.Nurse.Work();
        /// <summary>
        /// 午别列表
        /// </summary>
        ...
        public void Add(Neusoft.HISFC.Models.Nurse.WorkTemplet templet)
        {
            ...
            dr["Remark"] = Neusoft.FrameWork.Public.String.TakeOffSpecialChar(templet.Memo, "#", "%", "[", "'", "]", ",", "$", "(", ")", "|", "\'", "\"", "\\", "*", "^", "@", "!");
            dr["ReasonID"] = templet.Reason.ID;
            dr["ReasonName"] = Neusoft.FrameWork.Public.String.TakeOffSpecialChar(templet.Reason.Name, "#", "%", "[", "'", "]", ",", "$", "(", ")", "|", "\'", "\"", "\\", "*", "^", "@", "!");
        ...
        /// </summary>
        /// <param name="templet"></param>
        public void Add(Neusoft.HISFC.Models.Nurse.Work templet)
        {
            DataRowView dr = dv.AddNew();
            ...
            dr["Remark"] = Neusoft.FrameWork.Public.String.TakeOffSpecialChar(templet.Templet.Memo, "#", "%", "[", "'", "]", ",", "$", "(", ")", "|", "\'", "\"", "\\", "*", "^", "@", "!");
            dr["ReasonID"] = templet.Templet.Reason.ID;
            dr["ReasonName"] = Neusoft.FrameWork.Public.String.TakeOffSpecialChar(templet.Templet.Reason.Name, "#", "%", "[", "'", "]", ",", "$", "(", ")", "|", "\'", "\"", "\\", "*", "^", "@", "!");
        ...
        public int Save()
        {
            ...
            this.work.SetTrans(Neusoft.FrameWork.Management.PublicTrans.Trans);
        ...
        /// <returns></returns>
        private int SaveAdd(Neusoft.HISFC.BizLogic.Nurse.Work templetMgr, ArrayList alAdd, ref string Err)
        {
            try
            {
                foreach (Neusoft.HISFC.Models.Nurse.Work tempWork in alAdd)
                {
        ...
        /// <param name="Err"></param>
        /// <returns></returns>
        private int SaveModify(Neusoft.HISFC.BizLogic.Nurse.Work templetMgr, ArrayList alModify, ref string Err)
        {
            try
            {
                foreach (Neusoft.HISFC.Models.Nurse.Work tempWork in alModify)
                {
                    int returnValue = 0;
        ...
        /// <param name="Err"></param>
        /// <returns></returns>
        private int SaveDel(Neusoft.HISFC.BizLogic.Nurse.Work templetMgr, DataTable dvDel, ref string Err)
        {
            try
            {
       ...
       { 
            ...
            if (dt != null)
            {
                try
                {
                    ...
                    {
                        Neusoft.HISFC.Models.Nurse.Work tempWork = new Neusoft.HISFC.Models.Nurse.Work();
                        ...
                        tempWork.Templet.Oper.ID = Neusoft.FrameWork.Management.Connection.Operator.ID;
