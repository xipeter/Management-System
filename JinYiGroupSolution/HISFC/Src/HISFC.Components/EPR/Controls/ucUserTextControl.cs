...
namespace Neusoft.HISFC.Components.EPR.Controls
{
    ...
    public partial class ucUserTextControl : UserControl
    {
        ...
        //eusoft.HISFC.Management.Manager.Spell manager = new Neusoft.HISFC.Management.Manager.Spell();
        /// <summary>
        /// 设置数值
        /// </summary>
        /// <returns></returns>
        ...
        protected int GetValue()
        {
            ...
            try
            {
                ...
                ArrayList al = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.GetGroupList(code, type);
        ...
        public int Save()
        {
            ...
            {
                i = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.InsertUserText(this.myUserText);
            }
            else
            {
                i = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.UpdateUserText(this.myUserText);
            }
            if (i == -1)
            {
