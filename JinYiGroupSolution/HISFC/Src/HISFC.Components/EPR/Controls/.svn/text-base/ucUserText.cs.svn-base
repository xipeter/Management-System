...
namespace Neusoft.HISFC.Components.EPR.Controls
{
    ...
    public partial class ucUserText : UserControl
    {
        ...
        private void treeView1_ItemDrag(object sender, ItemDragEventArgs e)
        {
            ...
            try
            {
                Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.UpdateFrequency((node.Tag as Neusoft.HISFC.Models.Base.UserText).ID, Neusoft.FrameWork.Management.Connection.Operator.ID);
            }//更新不到无所谓的
            catch { }
        ...
        public void RefreshList()
        {
            ...
            if (this.groupInfo == null || this.groupInfo.ID == "")
                al = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.GetUserTextList(p.Dept.ID, 1);//获得科室
            else
                al = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.GetUserTextList(this.groupInfo.ID, p.Dept.ID, 1);
            ...
            if (this.groupInfo == null || this.groupInfo.ID == "")
                al = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.GetUserTextList(p.ID, 0);//获得个人
            else
                al = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.GetUserTextList(this.groupInfo.ID, p.ID, 0);
