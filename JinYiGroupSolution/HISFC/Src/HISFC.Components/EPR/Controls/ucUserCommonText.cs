...
namespace Neusoft.HISFC.Components.EPR.Controls
{
    ...
    public partial class ucUserCommonText : UserControl
    {
        ...
        public void RefreshList()
        {
            ...
            #region 获得常用符号列表
            ArrayList al = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.GetUserTextList("SIGN", 2);//获得常用符号列表
            if (al == null)
            {
            ...
            #region 获得常用单词
            al = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.GetUserTextList("WORD", 2);//获得常用单词列表
            if (al == null)
            {
                MessageBox.Show(Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.Err);
                return;
            ...
            {
                al = Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.GetUserTextList("RELATION", 2);//获得常用相关信息列表
                if (al == null)
                {
                    MessageBox.Show(Neusoft.HISFC.BizProcess.Factory.Function.IntegrateManager.Err);
                    return;
