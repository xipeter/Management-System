...
namespace Neusoft.HISFC.Components.Common.Controls
{
    ...
    /// [创建时间: 2006-12]<br></br>
    /// </summary>
    public partial class ucIMAListSelecct : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public delegate void SelectListHandler(string listCode, string state, Neusoft.FrameWork.Models.NeuObject targetDept);
        ...
        /// 当前操作的权限类型
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject privType = null;
        ...
        public DateTime BeginDate
        {
            get
            {
                return Neusoft.FrameWork.Function.NConvert.ToDateTime(this.dtpBegin.Text).Date;
            }
        }
        ...
        public DateTime EndDate
        {
            get
            {
                return Neusoft.FrameWork.Function.NConvert.ToDateTime(this.dtpEnd.Text).Date.AddDays(1);
            }
        }
