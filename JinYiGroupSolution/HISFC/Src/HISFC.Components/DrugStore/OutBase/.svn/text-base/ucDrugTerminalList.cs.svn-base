...
namespace Neusoft.HISFC.Components.DrugStore.OutBase
{
    ...
    ///  />
    /// </summary>
    public partial class ucDrugTerminalList : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public delegate void SelectTerminalHandler( Neusoft.HISFC.Models.Pharmacy.DrugTerminal drugTerminal );
        /// <summary>
        /// 终端选择事件
        /// </summary>
        ...
        /// </summary>
        /// <param name="drugTerminal">当前选中的终端实体</param>
        public delegate void SelectTerminalDoubleClickedHandler( Neusoft.HISFC.Models.Pharmacy.DrugTerminal drugTerminal );
        /// <summary>
        ///  终端双击事件
        /// </summary>
        ...
        public List<Neusoft.HISFC.Models.Pharmacy.DrugTerminal> SelectedTerminal
        {
            get
            {
                List<Neusoft.HISFC.Models.Pharmacy.DrugTerminal> selectednodes = new  List<Neusoft.HISFC.Models.Pharmacy.DrugTerminal>( );
                ListView lvi;
                ...
                foreach( ListViewItem item in lvi.Items)
                {
                    if( item.Checked)
                    {
                        ...
                        selectednodes.Add( item.Tag as Neusoft.HISFC.Models.Pharmacy.DrugTerminal );
                    }
                    else
                    {
                        selectednodes = null;
        ...
        #region 事件
            ...
            private void neuListView1_SelectedIndexChanged( object sender , EventArgs e )
            {
                if( this.neuListView1.SelectedItems.Count > 0 )
                {
                    ...
                    {
                        this.SelectTerminalEvent( this.neuListView1.SelectedItems[ 0 ].Tag as Neusoft.HISFC.Models.Pharmacy.DrugTerminal );
                    }
                }
            ...
            private void neuListView2_SelectedIndexChanged( object sender , EventArgs e )
            {
                if( this.neuListView2.SelectedItems.Count > 0 )
                {
                    if( this.SelectTerminalEvent != null )
                    {
                        this.SelectTerminalEvent( this.neuListView2.SelectedItems[ 0 ].Tag as Neusoft.HISFC.Models.Pharmacy.DrugTerminal );
                    }
                }
            }
            /// <summary>
            ...
            private void neuListView1_DoubleClick( object sender , EventArgs e )
            {
                if( this.neuListView1.SelectedItems.Count > 0 )
                {
                    ...
                    {
                        this.SelectTerminalDoubleClickedEvent( this.neuListView1.SelectedItems[ 0 ].Tag as Neusoft.HISFC.Models.Pharmacy.DrugTerminal );
                    }
                }
            }
            /// <summary>
            ...
            private void neuListView2_DoubleClick( object sender , EventArgs e )
            {
                if( this.neuListView2.SelectedItems.Count > 0 )
                {
                    if( this.SelectTerminalDoubleClickedEvent != null )
                    {
                        this.SelectTerminalDoubleClickedEvent( this.neuListView2.SelectedItems[ 0 ].Tag as Neusoft.HISFC.Models.Pharmacy.DrugTerminal );
                    }
                }
            }
            #endregion
