...
namespace Neusoft.HISFC.Components.DrugStore
{
    ...
    ///  />
    /// </summary>
    public class Function : Neusoft.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        public Function( )
        {
        ...
        public static int InitLabelPrintInterface()
        {
            ...
            try
            {
                System.Runtime.Remoting.ObjectHandle objHandel = System.Activator.CreateInstance("WinForms.Report", "Neusoft.WinForms.Report.DrugStore.ucRecipeLabel", false, System.Reflection.BindingFlags.CreateInstance, null, o, null, null, null);
        ...
        {
            object factoryInstance = Neusoft.FrameWork.WinForms.Classes.UtilInterface.CreateObject(typeof(Neusoft.HISFC.Components.DrugStore.Function), typeof(Neusoft.HISFC.BizProcess.Interface.Pharmacy.ICompoundPrint));
            
            Neusoft.HISFC.Components.DrugStore.Function.ICompoundPrint = factoryInstance as  Neusoft.HISFC.BizProcess.Interface.Pharmacy.ICompoundPrint;

            if (Neusoft.HISFC.Components.DrugStore.Function.ICompoundPrint == null)
            {
                return -1;
            }
            ...
            //    string labelValue = ctrlIntegrate.GetControlParam<string>(Neusoft.HISFC.BizProcess.Integrate.PharmacyConstant.Compound_Print_Label, true, "Neusoft.Report.DrugStore.ucCompoundLabel");
            ...
            //    Neusoft.HISFC.Components.DrugStore.Function.ICompoundPrint = oLabel as Neusoft.HISFC.BizProcess.Interface.Pharmacy.ICompoundPrint;
            //}
            //catch (System.TypeLoadException ex)
            //{
            //    Neusoft.FrameWork.WinForms.Classes.Function.HideWaitForm();
        ...
        public Type[] InterfaceTypes
        {
            get
            {
                ...
                printType[0] = typeof(Neusoft.HISFC.BizProcess.Interface.Pharmacy.ICompoundPrint);
