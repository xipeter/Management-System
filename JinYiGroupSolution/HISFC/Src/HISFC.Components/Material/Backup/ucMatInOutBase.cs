...
namespace Neusoft.HISFC.Components.Material
{
    public partial class ucMatInOutBase : UserControl
    {
        ...
        List<Neusoft.FrameWork.Models.NeuObject> privList = new List<Neusoft.FrameWork.Models.NeuObject>();
        ...
        /// 二级权限
        /// </summary>
        internal Neusoft.FrameWork.Models.NeuObject Class2Priv
        {
            get
            {
        ...
        /// 入库分类  ID 编码 Name 名称
        /// </summary>
        internal Neusoft.FrameWork.Models.NeuObject PrivType
        {
            get
            {
        ...
        /// </summary>
        internal Neusoft.FrameWork.Models.NeuObject TargetDept
        {
            get
            {
                return targetDept;
        ...
        /// 目标人 ID 编码 Name 名称
        /// </summary>
        internal Neusoft.FrameWork.Models.NeuObject TargetPerson
        {
            get
            {
        ...
        /// 当前操作员
        /// </summary>
        internal Neusoft.FrameWork.Models.NeuObject OperInfo
        {
            get
            {
        ...
        /// 当前登陆科室
        /// </summary>
        internal Neusoft.FrameWork.Models.NeuObject DeptInfo
        {
            get
            {
                ...
                try
                {
                    if (System.IO.File.Exists(Application.StartupPath + this.filePath))
                    {
                        ...
                        if (operNode != null)
                        {
                            ...
                            if (this.PrivType.ID == "")
                            {
                                Neusoft.FrameWork.Models.NeuObject info = this.privList[0] as Neusoft.FrameWork.Models.NeuObject;
                                this.PrivType = info;
                            }
                        }
                        else
        ...
        private ArrayList ArrayList(Neusoft.FrameWork.Models.NeuObject[] neuObject)
        {
