...
namespace Neusoft.HISFC.Components.Material.In
{
    ...
    /// 库存明细表触发器
    /// </summary>
    public partial class ucMatIn : ucIMAInOutBase, Neusoft.FrameWork.WinForms.Forms.IInterfaceContainer,Neusoft.FrameWork.WinForms.Classes.IPreArrange
    {
        public ucMatIn()
        {
            InitializeComponent();
        ...
        public Neusoft.HISFC.BizProcess.Interface.Material.IBillPrint IInPrint
        {
            get
            {
        ...
        {
            this.iInPrint = Neusoft.FrameWork.WinForms.Classes.UtilInterface.CreateObject(this.GetType(), typeof(Neusoft.HISFC.BizProcess.Interface.Material.IBillPrint)) as Neusoft.HISFC.BizProcess.Interface.Material.IBillPrint;
            if(this.iInPrint == null)
            {
        ...
        */
        ...
        private void ucMatIn_Load(object sender, EventArgs e)
        {
            if (System.Diagnostics.Process.GetCurrentProcess().ProcessName.ToUpper() != "DEVENV")
            {
                ...
                //int parma = Neusoft.HISFC.Components.Common.Classes.Function.ChoosePivDept("0510", ref testPrivDept);
