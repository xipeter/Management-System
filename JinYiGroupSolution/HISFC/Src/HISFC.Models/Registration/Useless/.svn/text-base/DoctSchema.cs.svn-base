...
namespace Neusoft.HISFC.Models.Registration
{
    ...
    public class DoctSchema
	{
		...
		/// 出诊医生
		/// </summary>
		protected Neusoft.FrameWork.Models.NeuObject doctor=new Neusoft.FrameWork.Models.NeuObject();
		/// <summary>
		/// 医生类别代码
		/// </summary>
		...
		/// 出诊诊室
		/// </summary>
		protected Neusoft.FrameWork.Models.NeuObject room=new Neusoft.FrameWork.Models.NeuObject();
		/// <summary>
		/// 诊台
		/// </summary>
		...
		/// 停诊原因
		/// </summary>
		protected Neusoft.FrameWork.Models.NeuObject stopReason=new Neusoft.FrameWork.Models.NeuObject();
		/// <summary>
		/// 停止人
		/// </summary>
		...
		/// 诊室
		/// </summary>
		public Neusoft.FrameWork.Models.NeuObject Room
		{
	...
	/// 午别实体
	/// </summary>
	public class Noon:Neusoft.HISFC.Models.Base.Spell {
