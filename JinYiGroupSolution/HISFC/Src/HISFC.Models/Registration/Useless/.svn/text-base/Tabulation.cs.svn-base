...
namespace Neusoft.HISFC.Models.Registration
{
	...
	/// </summary>
    [Serializable]
    public class Tabulation:Neusoft.FrameWork.Models.NeuObject
	{
		public Tabulation()
		{
			//
	...
	/// 排班类型实体
	/// </summary>
	public class WorkType:Neusoft.HISFC.Models.Base.Spell
	{		
		public WorkType()
		{
		}
	...
	public class TabularType:Neusoft.FrameWork.Models.NeuObject
	{
		/* by MaoKb
		 *05.7.26*/
