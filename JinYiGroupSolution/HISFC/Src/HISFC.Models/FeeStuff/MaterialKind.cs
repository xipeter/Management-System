...
namespace Neusoft.HISFC.Models.FeeStuff
{
    ...
    /// </summary>
    [Serializable]
    public class MaterialKind : Neusoft.HISFC.Models.Base.Item
    {
        public MaterialKind()
        {
        }
        ...
        /// 财务科目编码
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject accountCode = new Neusoft.FrameWork.Models.NeuObject();

        /// <summary>
        /// 财务科目名称
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject accountName = new Neusoft.FrameWork.Models.NeuObject();
        ...
        /// 财务科目编码
        /// </summary>
        public Neusoft.FrameWork.Models.NeuObject AccountCode
        {
            get
            {
        ...
        /// 财务科目名称
        /// </summary>
        public Neusoft.FrameWork.Models.NeuObject AccountName
        {
            get
            {
