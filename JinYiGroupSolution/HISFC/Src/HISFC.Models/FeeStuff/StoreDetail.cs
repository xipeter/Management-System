...
namespace Neusoft.HISFC.Models.FeeStuff
{
	...
	/// </summary>
    [Serializable]
	public class StoreDetail : Neusoft.FrameWork.Models.NeuObject
	{
		public StoreDetail()
		{
		...
		/// 加价人
		/// </summary>
		private Neusoft.HISFC.Models.Base.OperEnvironment modifyOper = new Neusoft.HISFC.Models.Base.OperEnvironment();
		...
		/// 加价人
		/// </summary>
		public Neusoft.HISFC.Models.Base.OperEnvironment ModifyOper
		{
			get
			{
