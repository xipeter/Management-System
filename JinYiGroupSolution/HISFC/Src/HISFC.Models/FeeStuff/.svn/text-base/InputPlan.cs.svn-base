...
namespace Neusoft.HISFC.Models.FeeStuff
{
	...
	/// </summary>
    [Serializable]
	public class InputPlan: Neusoft.FrameWork.Models.NeuObject
	{
		public InputPlan() 
		{
		...
		/// 采购员
		/// </summary>
		private Neusoft.FrameWork.Models.NeuObject stockOper = new Neusoft.FrameWork.Models.NeuObject();
		/// <summary>
		/// 采购时间
		/// </summary>
		...
		/// 采购信息
		/// </summary>
		public Neusoft.FrameWork.Models.NeuObject  StockOper
		{
			get
			{
