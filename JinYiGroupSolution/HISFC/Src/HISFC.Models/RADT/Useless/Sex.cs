...
namespace Neusoft.HISFC.Models.RADT
{
	...
	/// <example> 如何使用list例子
	/// <code>
	///     Dim c As New Neusoft.HISFC.Models.RADT.Patient
	...
	///
	///		Dim i As Int16
	///		Dim a As New Neusoft.HISFC.Models.RADT.Sex
	...
	public class Sex:Neusoft.FrameWork.Models.NeuObject
	{
		/// <summary>
		/// 性别类
		/// </summary>
		...
		public enuSex GetIDFromName(string Name)
		{
			...
			return (Neusoft.HISFC.Models.RADT.Sex.enuSex)int.Parse(Name);
		}
		/// <summary>
		/// 返回性别中文
		/// </summary>
