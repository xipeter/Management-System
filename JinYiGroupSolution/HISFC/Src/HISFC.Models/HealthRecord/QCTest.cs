...
namespace Neusoft.HISFC.Models.HealthRecord
{
    ...
    /// </summary>
    [Serializable]
    public class QCTest : Neusoft.FrameWork.Models.NeuObject
    {
        public QCTest()
        {
            //
        ...
        //人员 ID编码  name 名称
        private Neusoft.FrameWork.Models.NeuObject emplInfo = new Neusoft.FrameWork.Models.NeuObject();
        //分数
        private float mark;
        //医师 ID 级别编码 NAME 级别名称
        private Neusoft.FrameWork.Models.NeuObject levelInfo = new Neusoft.FrameWork.Models.NeuObject();
        //有效性标识
        ...
        /// </summary>
        public Neusoft.FrameWork.Models.NeuObject LevelInfo
        {
            get
            {
                return levelInfo;
