...
namespace Neusoft.HISFC.Models.Fee
{
    ...
    /// 
    [System.Serializable]
	public class Report:Neusoft.HISFC.Models.RADT.PatientInfo,Neusoft.HISFC.Models.Fee.IFeeItem
	{
		public Report()
		{
			//
		...
		public new Report Clone() {
			Neusoft.HISFC.Models.Fee.Report obj=base.MemberwiseClone() as Report;
