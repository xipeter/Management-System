namespace Neusoft.HISFC.Models.PhysicalExamination.Management 
{
	...
	/// </summary>
    [System.Serializable]
    public class Item : Neusoft.HISFC.Models.PhysicalExamination.Base.PE
	{
		/// <summary>
		/// 构造函数
		/// </summary>
		...
		/// 体检结果类型
		/// </summary>
		private Neusoft.HISFC.Models.PhysicalExamination.Enum.EnumResultType resultType;
		...
		/// 体检结果类型
		/// </summary>
		public Neusoft.HISFC.Models.PhysicalExamination.Enum.EnumResultType ResultType 
		{
			get 
			{
