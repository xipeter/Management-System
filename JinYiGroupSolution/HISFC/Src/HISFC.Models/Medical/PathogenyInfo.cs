...
{
    [Serializable]
    public class PathogenyInfo : Neusoft.FrameWork.Models.NeuObject
    {
        public PathogenyInfo()
        {
            // TODO: 在此处添加构造函数逻辑
        }
        ...
        #endregion
        #region 方法
        public new PathogenyInfo Clone()
        {
            PathogenyInfo pathogenyInfo = base.Clone() as PathogenyInfo;
            return pathogenyInfo;
        }
        #endregion
    }
}