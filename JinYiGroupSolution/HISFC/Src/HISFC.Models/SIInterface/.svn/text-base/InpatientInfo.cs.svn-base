...
namespace Neusoft.HISFC.Models.SIInterface {
	...
	/// </summary>
    [Serializable]
    public class InpatientInfo:Neusoft.FrameWork.Models.NeuObject
	{
		...
		private Neusoft.FrameWork.Models.NeuObject regType = new Neusoft.FrameWork.Models.NeuObject();
		/// <summary>
		/// 就诊类别 1-住院2-门诊特定项目
		/// </summary>
		public Neusoft.FrameWork.Models.NeuObject RegType
		{
			get
			{
				return regType;
