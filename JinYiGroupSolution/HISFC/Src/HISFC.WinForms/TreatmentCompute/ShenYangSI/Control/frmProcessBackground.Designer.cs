namespace ShenYangCitySI.Control
{
    partial class frmProcessBackground
    {
        ...
        {
            this.ucQueryInpatientNo = new Neusoft.UFC.Common.Controls.ucQueryInpatientNo();
            this.btnCallBack = new Neusoft.NFC.Interface.Controls.NeuButton();
            ...
            this.ucQueryInpatientNo.ShowState = Neusoft.UFC.Common.Controls.enuShowState.InhosBeforBalanced;
            this.ucQueryInpatientNo.Size = new System.Drawing.Size(197, 27);
            this.ucQueryInpatientNo.TabIndex = 1;
            this.ucQueryInpatientNo.myEvent += new Neusoft.UFC.Common.Controls.myEventDelegate(this.ucQueryInpatientNo_myEvent);
            // 
            // btnCallBack
            // 
            ...
            this.btnCallBack.Style = Neusoft.NFC.Interface.Controls.StyleType.Fixed3D;
            this.btnCallBack.TabIndex = 2;
            this.btnCallBack.Text = "召回";
            this.btnCallBack.Type = Neusoft.NFC.Interface.Controls.General.ButtonType.None;
        ...
        protected Neusoft.UFC.Common.Controls.ucQueryInpatientNo ucQueryInpatientNo;
        private Neusoft.NFC.Interface.Controls.NeuButton btnCallBack;
