...
namespace InterfaceInstanceDefault.IPrepayPrint
{
    ...
    ///  />
    /// </summary>
    public partial class IPrepayPrintDefault  : System.Windows.Forms.UserControl ,Neusoft.HISFC.BizProcess.Interface.FeeInterface.IPrepayPrint
    {
        ...
        public int Print()
        {
            ...
            //Neusoft.HISFC.Models.Base.PageSize ps = new Neusoft.HISFC.Models.Base.PageSize("ZYYJ", 0, 0);
