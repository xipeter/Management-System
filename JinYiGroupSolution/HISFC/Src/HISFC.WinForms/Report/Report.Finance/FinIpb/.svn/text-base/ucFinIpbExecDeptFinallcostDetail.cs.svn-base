...
namespace Neusoft.Report.Finance.FinIpb
{
    ...
    /// 执行科室收入明细
    /// </summary>
    public partial class ucFinExecDeptFinallcostDetail:NeuDataWindow.Controls.ucQueryBaseForDataWindow//FrameWork.WinForms.Controls.ucQueryBaseForDataWindow
    {
