...
{
    public partial class ucFinIpbPrepayDayReport : NeuDataWindow.Controls.ucQueryBaseForDataWindow 
    {
        ...
        protected override void OnLoad()
        {
            ...
            System.Collections.ArrayList constantList = manager.GetDepartment(Neusoft.HISFC.Models.Base.EnumDepartmentType.N);
