...
namespace Neusoft.WinForms.Report.Finance.FinIpb
{
    ...
    /// 出院病人费用汇总（已出院）
    /// </summary>
    public partial class ucFinIpbStatFeeOut : Neusoft.HISFC.Components.Common.Report.ucCrossQueryBaseForFarPoint
    {
        public ucFinIpbStatFeeOut()
        {
            InitializeComponent();
        }
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            if (comDept.Text == "按患者所在科室查询")
            {
                ...
                this.QuerySql = "WinForms.Report.Finance.FinIpb.ucFinIpbStatFeeInhosDeptOut";
            ...
            {
                this.QuerySqlTypeValue = QuerySqlType.id;
                this.QuerySql = "WinForms.Report.Finance.FinIpb.ucFinIpbStatFeeDOCDeptOut";
                //this.DataCrossValues = "2";
                //this.DataCrossColumns = "1";
                //this.DataCrossRows = "0";
            }
            if (comDept.Text == "按执行科室查询")
            {
                ...
                this.QuerySqlTypeValue = QuerySqlType.id;
                this.QuerySql = "WinForms.Report.Finance.FinIpb.ucFinIpbStatFeeEXEDeptOut";
                //this.DataCrossValues = "2";
                //this.DataCrossColumns = "1";
                //this.DataCrossRows = "0";
            }
            ...
            this.neuSpread1_Sheet1.SetText(1, 0, "住院收入统计汇总表（出院）");
