...
namespace Neusoft.Report.Finance.FinReg
{
    ...
    /// 预约情况查询
    /// </summary>
    public partial class ucFinRegQueryBooking : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private Neusoft.FrameWork.Public.ObjectHelper objHelper =null;       
        /// <summary>
        /// 初始化
        /// </summary>
        private void init()
