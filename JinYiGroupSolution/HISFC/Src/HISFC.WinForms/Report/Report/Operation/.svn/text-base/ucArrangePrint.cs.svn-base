...
namespace Neusoft.WinForms.Report.Operation
{
    ...
    ///  />
    /// </summary>
    public partial class ucArrangePrint : UserControl, Neusoft.HISFC.BizProcess.Interface.Operation.IArrangePrint
    {
...
#region 字段
        ...
        Neusoft.HISFC.BizProcess.Interface.Operation.EnumArrangeType arrangeType = Neusoft.HISFC.BizProcess.Interface.Operation.EnumArrangeType.Anaesthesia;
#endregion
...
#region 属性
        ...
        /// 安排类型
        /// </summary>
        public Neusoft.HISFC.BizProcess.Interface.Operation.EnumArrangeType ArrangeType
        {
            get
            {
