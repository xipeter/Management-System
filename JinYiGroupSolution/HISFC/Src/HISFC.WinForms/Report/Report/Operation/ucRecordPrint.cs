...
namespace Neusoft.WinForms.Report.Operation
{
    ...
    ///  />
    /// </summary>
    public partial class ucRecordPrint : UserControl ,Neusoft.HISFC.BizProcess.Interface.Operation.IRecordFormPrint
    {
...
#region IRecordFormPrint 成员
        ...
        public Neusoft.HISFC.Models.Operation.OperationRecord OperationRecord
        {
            set 
            {
                ...
                //string strDiagnoses = "";
                //foreach (neusoft.HISFC.Models.Case.DiagnoseBase myDiagnose in thisOpsApp.DiagnoseAl)
                //{
                //    //组合各诊断名为一个字符串
                //    if (strDiagnoses != "")
                ...
                {
                    obj = (Neusoft.FrameWork.Models.NeuObject)(thisOpsApp.HelperAl[i]);
                    switch (i)
                    {
                        case 0:
