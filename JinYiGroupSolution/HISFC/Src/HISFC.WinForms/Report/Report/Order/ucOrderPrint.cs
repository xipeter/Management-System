...
namespace Neusoft.WinForms.Report.Order
{
    ...
    /// </summary>
    public partial class ucOrderPrint : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IPrintOrder
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        //床位业务层
        private Neusoft.HISFC.BizLogic.Manager.Bed bedMgr = new Neusoft.HISFC.BizLogic.Manager.Bed();
