...
{
    public partial class ucFilterItem : UserControl, Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IChooseItemForOutpatient
    {
        public ucFilterItem()
        {
            InitializeComponent();
        ...
        /// 显示项目类别
        /// </summary>
        protected Neusoft.HISFC.Models.Base.ItemTypes itemType = Neusoft.HISFC.Models.Base.ItemTypes.All;

        /// <summary>
        /// 当前选择的项目
        /// </summary>
        protected Neusoft.HISFC.Models.Base.Item nowItem = new Neusoft.HISFC.Models.Base.Item();
        ...
        public Neusoft.HISFC.BizProcess.Integrate.FeeInterface.ChooseItemTypes ChooseItemType
        {
            get
            {
                return Neusoft.HISFC.BizProcess.Integrate.FeeInterface.ChooseItemTypes.ItemChanging;
            }
            set 
            {
        ...
        public Neusoft.HISFC.Models.Base.ItemKind ItemKind
        {
            get
            {
                return Neusoft.HISFC.Models.Base.ItemKind.All;
            }
            set { }
        }
        /// <summary>
