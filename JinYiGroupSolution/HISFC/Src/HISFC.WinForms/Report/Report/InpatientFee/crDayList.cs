...
namespace Neusoft.Report.InpatientFee {
    ...
    public class crDayList : ReportClass {
    ...
    public class CachedcrDayList : Component, ICachedReport {
        
        public CachedcrDayList() {
        }
