    ...
    public partial class ucPatientFeeQuery : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void QueryPatientByInpatientNO()
        {
           ...
           // Neusoft.HISFC.Models.RADT.PatientInfo patientInfo = this.radtManager.QueryPatientInfoByInpatientNO(this.ucQueryInpatientNo1.InpatientNo);
            Neusoft.HISFC.Models.RADT.PatientInfo patientInfo = this.radtInpatientFee.QueryPatientInfoByInpatientNO(this.ucQueryInpatientNo1.InpatientNo);
        ...
        private void neuLabel33_Click(object sender, EventArgs e)
        {
