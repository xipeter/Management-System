...
{
    public partial class ucPopDayReportQuery : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        Neusoft.HISFC.BizLogic.Fee.InpatientDayReport FeeInaptientDayReport = new Neusoft.HISFC.BizLogic.Fee.InpatientDayReport();
        Neusoft.HISFC.BizProcess.Integrate.Manager managerIntegrate = new Neusoft.HISFC.BizProcess.Integrate.Manager();
        /// <summary>
        /// 设置一个delegate
        /// </summary>
        /// <param name="dayReport"></param>
        public delegate void mydelegateEndChoose(Neusoft.HISFC.Models.Fee.DayReport dayReport);
