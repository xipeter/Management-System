...
namespace Neusoft.WinForms.Report.InpatientFee
{
    public partial class ucDayReport : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// </summary>
        Neusoft.HISFC.BizLogic.Fee.InpatientDayReport feeDayreport = new Neusoft.HISFC.BizLogic.Fee.InpatientDayReport();
        ...
        protected override Neusoft.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            //toolBarService.AddToolButton("查询", "查询以往日结信息", (int)Neusoft.FrameWork.WinForms.Classes.EnumImageList.A查询, true, false, null);

            //toolBarService.AddToolButton("打印", "打印日结报表", (int)Neusoft.FrameWork.WinForms.Classes.EnumImageList.A打印, true, false, null);
            ...
            //toolBarService.AddToolButton("保存", "保存日结信息", (int)Neusoft.FrameWork.WinForms.Classes.EnumImageList.B保存, true, false, null);
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            Neusoft.FrameWork.WinForms.Classes.Function.PopShowControl(ucQuery);
