...
namespace Neusoft.HISFC.BizProcess.Integrate.FeeInterface
{
    ...
    */
    ...
    public interface IOutpatientInfomation 
    {
        ...
        event DelegateNameEnter NameEnter;
        /// <summary>
        /// 当前收费序列
        /// </summary>
    ...
    /// <param name="r"></param>
    /// <returns></returns>
    public delegate bool DelegateNameEnter(Neusoft.HISFC.Models.Registration.Register r);
    #endregion
    ...
    /// 实收金额回车
    /// </summary>
    public delegate void DelegateRealCostEnter();
    ...
    public interface IOutpatientOtherInfomationRight 
    {
        ...
        event DelegateRealCostEnter RealCostEnter;
    }
