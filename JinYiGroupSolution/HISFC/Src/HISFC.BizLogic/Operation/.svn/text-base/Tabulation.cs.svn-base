...
namespace Neusoft.HISFC.BizLogic.Operation
{
    ...
    /// 排班管理类
    /// </summary> 
    public class Tabulation : Neusoft.FrameWork.Management.Database
    {
        /// <summary>
        /// 排班管理类
        /// ed.huangxw
        ...
        /// 排班实体
        /// </summary>
        private Neusoft.HISFC.Models.Registration.Tabulation tabulation;
        private Neusoft.HISFC.Models.Registration.WorkType worktype;
        private Neusoft.HISFC.Models.Registration.TabularType tabulartype;
        ...
        public int Insert(Neusoft.HISFC.Models.Registration.WorkType type)
        {
            ...
            try
            {
                sql = string.Format(sql, type.ID, type.Name, type.SpellCode, type.ClassID,
                    ...
                    type.PositiveDays.ToString(), type.MinusDays.ToString(), type.Memo, Neusoft.FrameWork.Function.NConvert.ToInt32(type.Isvalid),
   ...
   AND dept_code='{1}'*/
        ...
        private int QueryTabular(string sql)
        {
            ...
            while (Reader.Read())
            {
                ...
                tabulation.Workdate = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[2].ToString());//出勤日期
                ...
                if (Reader.IsDBNull(6) == false) tabulation.Kind.BeginTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[6].ToString());
                if (Reader.IsDBNull(7) == false) tabulation.Kind.EndTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[7].ToString());
                if (Reader.IsDBNull(8) == false) tabulation.Kind.MinusDays = Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[8].ToString());
                if (Reader.IsDBNull(9) == false) tabulation.Kind.PositiveDays = Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[9].ToString());
                tabulation.arrangeID = Reader[10].ToString();//排班序号
                tabulation.OperID = Reader[11].ToString();//操作员
                if (Reader.IsDBNull(12) == false) tabulation.OperDate = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[12].ToString());//操作时间
                tabulation.Memo = Reader[14].ToString();//备注
                tabulation.SortID = Neusoft.FrameWork.Function.NConvert.ToInt32(Reader[15].ToString());
        ...
        private int QueryType(string sql)
        {
            ...
            while (Reader.Read())
            {
                worktype = new Neusoft.HISFC.Models.Registration.WorkType();
                ...
                if (Reader.IsDBNull(7) == false) worktype.BeginTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[7].ToString());
                if (Reader.IsDBNull(8) == false) worktype.EndTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[8].ToString());
                if (Reader.IsDBNull(9) == false) worktype.Quotiety = Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[9].ToString());//扣款系数
                if (Reader.IsDBNull(10) == false) worktype.PositiveDays = Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[10].ToString());//出勤权值
                if (Reader.IsDBNull(11) == false) worktype.MinusDays = Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[11].ToString());//缺勤权值
                worktype.Memo = Reader[12].ToString();//备注
                if (Reader.IsDBNull(13) == false) worktype.Isvalid = Neusoft.FrameWork.Function.NConvert.ToBoolean(Reader[13].ToString());
                worktype.OperID = Reader[14].ToString();//操作员
                if (Reader.IsDBNull(15) == false) worktype.OperDate = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[15].ToString());
        ...
        public int QueryTabularType(string sql)
        {
            ...
            while (Reader.Read())
            {
                tabulartype = new Neusoft.HISFC.Models.Registration.TabularType();
                tabulartype.EmpCode = Reader[2].ToString();//员工代码
                tabulartype.DeptCode = Reader[3].ToString();
                if (Reader.IsDBNull(4) == false) tabulartype.WorkDate = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[4].ToString());
                tabulartype.Name = Reader[5].ToString();
                tabulartype.ClassCode = Reader[6].ToString();
                if (Reader.IsDBNull(7) == false) tabulartype.PositiveDays = Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[7].ToString());
                if (Reader.IsDBNull(8) == false) tabulartype.MinusDays = Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[8].ToString());
                tabulartype.OperCode = Reader[9].ToString();
                if (Reader.IsDBNull(10) == false) tabulartype.OperDate = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[10].ToString());
                if (Reader.IsDBNull(11) == false) tabulartype.IsChecked = Neusoft.FrameWork.Function.NConvert.ToBoolean(Reader[11].ToString());
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        private int valid(Neusoft.HISFC.Models.Registration.WorkType type)
        {
            ...
            if (Neusoft.FrameWork.Public.String.ValidMaxLengh(type.Name, 20) == false)
            {
            ...
            if (Neusoft.FrameWork.Public.String.ValidMaxLengh(type.Memo, 100) == false)
            {
                this.Err = "备注必须不大于50个汉字!";
                return -1;
            }
            if (Neusoft.FrameWork.Public.String.ValidMaxLengh(type.SpellCode, 8) == false)
            {
                this.Err = "拼音码必须不大于8个字符!";
                return -1;
            }
            if (Neusoft.FrameWork.Public.String.ValidMaxLengh(type.ClassID, 2) == false)
            {
            ...
            if (Neusoft.FrameWork.Public.String.ValidMaxLengh(type.Sign, 8) == false)
            {
                this.Err = "简称必须不大于8个字符!";
                return -1;
            }
            if (Neusoft.FrameWork.Public.String.ValidMaxLengh(type.ID, 3) == false)
            {
