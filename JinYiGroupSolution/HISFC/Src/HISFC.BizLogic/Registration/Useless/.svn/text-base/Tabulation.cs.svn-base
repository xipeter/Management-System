   ...
   AND dept_code='{1}'*/
		...
		private int QueryTabular(string sql)
		{
			...
			while(Reader.Read())
			{
				...
				if(Reader.IsDBNull(8)==false)tabulation.Kind.BeginTime=Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[8].ToString());
				if(Reader.IsDBNull(9)==false)tabulation.Kind.EndTime=Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[9].ToString());
				if(Reader.IsDBNull(10)==false)tabulation.Kind.MinusDays=Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[10].ToString());
				if(Reader.IsDBNull(11)==false)tabulation.Kind.PositiveDays=Neusoft.FrameWork.Function.NConvert.ToDecimal(Reader[11].ToString());
				tabulation.arrangeID=Reader[12].ToString();//排班序号
				tabulation.OperID=Reader[13].ToString();//操作员
				if(Reader.IsDBNull(14)==false)tabulation.OperDate=Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[14].ToString());//操作时间
