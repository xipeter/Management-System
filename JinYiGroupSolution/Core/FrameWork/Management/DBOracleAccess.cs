...
namespace Neusoft.FrameWork.Management
{
    ...
    /// wolf 2004-6
    /// </summary>
    public class DBOracleAccess : Neusoft.FrameWork.Models.NeuManageObject, IDataBase
    {
        ...
        protected Oracle.DataAccess.Client.OracleDataReader TempReader1;
        protected Oracle.DataAccess.Client.OracleDataReader TempReader2;
        protected Oracle.DataAccess.Client.OracleDataReader reader;
        //protected Oracle.DataAccess.Client.OracleCommand tempCommand = new OracleCommand();
        /// <summary>
        /// DataReader 数据读取指针
        /// </summary>
        ...
        public DBOracleAccess(string errLogoFileName)
        {
        ...
        public void SetTrans(IDbTransaction Trans)
        {
            try
            {
                this.command.Connection = this.con as Oracle.DataAccess.Client.OracleConnection; //= (Oracle.DataAccess.Client.OracleTransaction)Trans;
            }
            catch (Exception ex)
            {
        ...
        /// 连接 私有
        /// </summary>
        protected Oracle.DataAccess.Client.OracleConnection con1;
        /// <summary>
        /// 命令 私有
        /// </summary>
        protected Oracle.DataAccess.Client.OracleCommand command;
        /// <summary>
        /// 日志 私有
        /// </summary>
        /// <summary>
        ...
        a:
            ...
            try
            {
                ...
                Reader.FetchSize = this.command.RowSize * 10000;
            }
            catch (OracleException ex)
            {
                this.Err = "执行产生错误!" + ex.Message;
        ...
        public string ExecSqlReturnOne(string strSql, string defaultstring)
        {
            ...
            if (this.ExecQuery(strSql, ref this.TempReader1) == 0)
            {
                ...
                {
                    string strReturn;
                    if (((Oracle.DataAccess.Client.OracleDataReader)this.TempReader1).HasRows == false) return defaultstring;
        ...
        public int InputLong(string strSql, string data)
        {
            ...
            strParam = strSql.Substring(i + 1, 1);
            OracleParameter param = command.Parameters.Add(strParam, OracleDbType.Long);
            param.Direction = System.Data.ParameterDirection.Input;
        ...
        public int ExecEvent(string strSql, ref string Return)
        {
            ...
            try
            {
                ...
                for (int i = 1; i < prcParams.GetUpperBound(0); i = i + 4)
                {
                    ...
                    else if (param.OracleDbType == OracleDbType.Varchar2)
                    {
                        param.Size = 50;
                    }
