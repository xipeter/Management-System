...
namespace Neusoft.FrameWork.WinForms.Controls
{
	...
	/// </summary>
	public class NeuBitmapComboBox : ComboBoxBase
	{
		Bitmap[] bitmapsArray;
		string[] bitmapsNames;
		...
		public NeuBitmapComboBox(Bitmap[] BitmapsArray, String[] bitmapsNames)
		{
		...
		public NeuBitmapComboBox(Bitmap[] BitmapsArray, String[] bitmapsNames, bool toolBarUse): base(toolBarUse)
		{
			DropDownStyle = ComboBoxStyle.DropDownList;
			bitmapsArray = BitmapsArray;
