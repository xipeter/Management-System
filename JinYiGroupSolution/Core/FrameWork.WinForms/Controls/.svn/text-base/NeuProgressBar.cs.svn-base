...
namespace Neusoft.FrameWork.WinForms.Controls
{
	...
	public delegate void ProgressBarPropertyChangedHandler(NeuProgressBar pogressBar, ProgressBarProperty prop);

	/// <summary>
	/// Summary description for FlatProgressBar.
	/// </summary>
	[ToolboxBitmap(typeof(ProgressBar))]
	public class NeuProgressBar : System.Windows.Forms.Control
	{
		...
		Color foregroundColor = ColorUtil.VSNetSelectionColor;
		Color borderColor = ColorUtil.VSNetBackgroundColor;
		int _value = 0;
		int step = 1;
		int min = 0;
		int max = 100;
		...
		public NeuProgressBar(Bitmap foregroundBitmap, Bitmap backgroundBitmap)
		{
		...
		public NeuProgressBar(Bitmap foregroundBitmap)
		{
			InitializeProgressControl(ProgressBarType.Bitmap, ColorUtil.VSNetStripeColor, 
				SystemColors.Highlight, SystemColors.Highlight, 
		...
		public NeuProgressBar(Color gradientStartColor, Color gradientEndColor)
		{
		...
		public NeuProgressBar(Color gradientStartColor, Color gradientMiddleColor, Color gradientEndColor)
		{
			InitializeProgressControl(ProgressBarType.Gradient, ColorUtil.VSNetStripeColor, 
				SystemColors.Highlight, SystemColors.Highlight, 
