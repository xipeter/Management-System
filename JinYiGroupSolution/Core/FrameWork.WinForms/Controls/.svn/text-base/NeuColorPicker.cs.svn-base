...
namespace Neusoft.FrameWork.WinForms.Controls
{
	...
	/// </summary>
	public class NeuColorPicker : System.Windows.Forms.UserControl {
		...
		private void DrawColorPickerState()
		{
			...
			using (Graphics g = CreateGraphics())
			{
				...
				if ( drawState == DrawState.Normal )
				{
					...
					// Draw white border
					g.DrawRectangle(new Pen(Color.Black), rc.Left, rc.Top, rc.Width-1, rc.Height-1);
				}
	...
	internal class ArrowButton : System.Windows.Forms.Button
	{
		...
		NeuColorPicker colorPicker = null;
		DrawState drawState = DrawState.Normal;
				
		public ArrowButton( NeuColorPicker colorPicker )
		{
