...
namespace Neusoft.FrameWork.WinForms.Controls
{
	...
	public class NeuCheckBox : System.Windows.Forms.CheckBox , INeuControl
	{
		...
		public NeuCheckBox()
		{
			...
			checkMarkChecked = ResourceUtil.LoadBitmapResource(Type.GetType("Neusoft.FrameWork.WinForms.Controls.NeuCheckBox"),
				                                "Neusoft.FrameWork.WinForms.Controls.Resources.Controls", "CheckMarkChecked");
			Debug.Assert(checkMarkChecked != null);
			checkMarkUnchecked = ResourceUtil.LoadBitmapResource(Type.GetType("Neusoft.FrameWork.WinForms.Controls.NeuCheckBox"),
				                                "Neusoft.FrameWork.WinForms.Controls.Resources.Controls", "CheckMarkUnchecked");
		...
		protected override  void WndProc(ref Message m)
		{
			...
			switch(m.Msg)
			{
				case ((int)Msg.WM_PAINT):
				{
					...
					base.WndProc(ref m);
                    if (this.Style != StyleType.Fixed3D)
                    {
