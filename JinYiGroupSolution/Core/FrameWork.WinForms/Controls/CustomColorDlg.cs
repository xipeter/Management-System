...
namespace Neusoft.FrameWork.WinForms.Controls
{
	...
	public class CustomColorDlg : System.Windows.Forms.Form
	{
		...
		private NeuNumericTextBox hueEdit;
		private NeuNumericTextBox satEdit;
		private NeuNumericTextBox lumEdit;
		private NeuNumericTextBox redEdit;
		private NeuNumericTextBox greenEdit;
		private NeuNumericTextBox blueEdit;
		...
		public CustomColorDlg()
		{
			...
			Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("Neusoft.FrameWork.WinForms.Controls.CustomColorDlg"));
			rm = new ResourceManager("Neusoft.FrameWork.WinForms.Controls.Resources.ImagesColorPicker", thisAssembly);
			//
		...
		private void InitializeComponent()
		{
			...
			this.hueEdit = new Neusoft.FrameWork.WinForms.Controls.NeuNumericTextBox();
			this.satEdit = new Neusoft.FrameWork.WinForms.Controls.NeuNumericTextBox();
			this.lumEdit = new Neusoft.FrameWork.WinForms.Controls.NeuNumericTextBox();
			this.redEdit = new Neusoft.FrameWork.WinForms.Controls.NeuNumericTextBox();
			this.greenEdit = new Neusoft.FrameWork.WinForms.Controls.NeuNumericTextBox();
			this.blueEdit = new Neusoft.FrameWork.WinForms.Controls.NeuNumericTextBox();
