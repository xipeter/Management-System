...
namespace Neusoft.WinForms.Controls
{
    ...
    public class NComboBox : ComboBoxBase
    {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    if (_type.Name == "List`1")
                    {
                        ...
                        this.formObject = this.CreateInstance("NFC.Interface", formName);
                    }
        ...
        public int RowCout
        {
            ...
            {
                rowCout = value;
                this.NeuHeight = RowCout * 23 + 25 * NFC.Function.NConvert.ToInt32(IsColumnHeader);
            }
        }
        ...
        {
            IList<NFC.Public.EnumHelper.EnumObject> list = NFC.Public.EnumHelper.Current.EnumList<T>();
            ...
            using (DataTable dt = new DataTable())
            {
                ...
                foreach (T Info in datas)
                {
                    ...
                    else
                    {
                        ...
                        {
                            row["拼音码"] = NFC.Public.String.GetSpell(name);
                        }
                    }
        ...
        private void CmbBox_TextChanged(object sender, EventArgs e)
        {
            ...
            string queryCode = "";
            queryCode = sign + NFC.Public.String.TakeOffSpecialChar(CmbBox.Text) + sign;
            string filter = "";
