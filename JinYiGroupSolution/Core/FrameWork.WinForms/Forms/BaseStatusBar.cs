	...
	public class BaseStatusBar : BaseForm
	{
		...
		protected void SetPanel()
		{
			...
			try
			{
                ...
                //{1B10BCB7-8133-4282-8479-9C41FE5A23FD}  区域语言转换
                //{70BC3C2C-823D-4c56-A06A-3E584EA13B2B}  获取当前登录IP并显示在界面上
                Panel.Text = Neusoft.FrameWork.Management.Language.Msg( "部门" ) + ":" + ((Neusoft.HISFC.Models.Base.Employee)Neusoft.FrameWork.Management.Connection.Operator).Dept.Name + "      IP:" + ip.ToString();
